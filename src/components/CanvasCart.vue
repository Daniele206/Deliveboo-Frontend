    ...
    methods:{
      ...
      sendOrders(){
        ...
        if (this.mail.length < 3 || this.mail.length > 30) {
          ...
          this.errorMail.innerHTML = 'La mail deve avere minimo 3 caratteri e massimo 30';
        }
        ...
        if(this.validName === true && this.validMail === true  && this.validAddress === true && this.validTelefon === true){
          this.data = {
            'name': this.name,
            'mail': this.mail,
